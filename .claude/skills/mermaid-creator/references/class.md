...
Class diagrams represent object-oriented structures, showing classes, attributes, methods, and
relationships.
...
- **Inheritance**: `assets/examples/class/inheritance.mmd` Animal base class with Dog and Cat
  subclasses

- **Interface Implementation**: `assets/examples/class/interface.mmd` Circle implementing Drawable
  and Resizable interfaces

- **Composition vs Aggregation**: `assets/examples/class/composition-aggregation.mmd` Car with
  Engine (composition) and Wheels (aggregation)

- **Full System**: `assets/examples/class/full-system.mmd` User, Post, Comment, Category
  relationships

### Recommended: Domain Model (DDD-style)

For domain-driven design, show aggregates with composition, value objects, and cardinality.
Include only the attributes and methods that define the domain — not infrastructure details:
...
classDiagram
    ...
    OrderLine "1" --> "1" Product : references
```
